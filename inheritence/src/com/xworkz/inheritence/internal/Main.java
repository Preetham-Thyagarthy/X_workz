package X_workz.inheritence.src.com.xworkz.inheritence.internal;
    ...
    public class Main {
        public static void main(String[] args) {
            ...
            Nagaland nagaland = new Nagaland();
            nagaland.capital();
            nagaland.language();
            nagaland.population();
            nagaland.famousFood();
            nagaland.touristSpot();
            ...
            Rajasthan rajasthan = new Rajasthan();
            rajasthan.capital();
            rajasthan.language();
            rajasthan.population();
            rajasthan.famousFood();
            rajasthan.touristSpot();
            ...
            tamilNadu.famousFood();
            tamilNadu.touristSpot();
            ...
            telangana.famousFood();
            telangana.touristSpot();
            ...
            Uttarakhand uttarakhand = new Uttarakhand();
            uttarakhand.capital();
            uttarakhand.language();
            uttarakhand.population();
            uttarakhand.famousFood();
            uttarakhand.touristSpot();
            ...
            uttarPradesh.capital();
            uttarPradesh.language();
            uttarPradesh.population();
            uttarPradesh.famousFood();
            uttarPradesh.touristSpot();
            ...
            westBengal.capital();
            westBengal.language();
            westBengal.population();
            westBengal.famousFood();
            westBengal.touristSpot();
            ...
            ocean.numberOfOceans();
            ocean.oceanCurrents();
            ocean.marineLife();
            ocean.oceanExploration();
            ocean.oceanPollution();
            ...
            volcano.eruptionTypes();
            volcano.famousEruption();
            volcano.eruptionFrequency();
            volcano.highestVolcano();
            volcano.volcanicHazards();
            ...
            nebula.nebulaColors();
            nebula.nebulaExpansion();
            nebula.nebulaComposition();
            nebula.nebulaObservation();
            nebula.nebulaDistance();
            ...
            spaceStation.spaceStationModules();
            spaceStation.spaceStationCrew();
            spaceStation.spaceStationPower();
            spaceStation.microgravityExperiments();
            spaceStation.futureSpaceStations();
            ...
            supernova.famousSupernovae();
            supernova.supernovaNeutronStar();
            supernova.supernovaBlackHole();
            supernova.supernovaShockWave();
            supernova.supernovaDetection();
            ...
            quasar.quasarMagneticField();
            quasar.quasarVariability();
            quasar.quasarRadioEmissions();
            quasar.quasarJetEjection();
            quasar.quasarRoleInUniverse();
            ...
            toothpaste.whiteningFeature();
            toothpaste.herbalVariant();
            toothpaste.gelType();
            toothpaste.fluorideFreeOption();
            toothpaste.sensitivityRelief();
            ...
            shampoo.antiDandruffFeature();
            shampoo.sulfateFreeOption();
            shampoo.herbalShampoo();
            shampoo.volumizingShampoo();
            shampoo.deepConditioning();
            ...
            Soap soap = new Soap();
            soap.antibacterialFeature();
            soap.fragranceVariety();
            soap.moisturizingSoap();
            soap.herbalSoap();
            soap.charcoalSoap();
            ...
            perfume.floralFragrance();
            perfume.woodyFragrance();
            perfume.citrusFragrance();
            perfume.longLasting();
            perfume.alcoholFree();
            ...
            ShavingCream shavingCream = new ShavingCream();
            shavingCream.sensitiveSkin();
            shavingCream.mentholCooling();
            shavingCream.thickFoam();
            shavingCream.fragranceFree();
            shavingCream.organicIngredients();
